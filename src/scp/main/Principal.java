...
public class Principal extends Application {
    ...
    public void start(Stage stage) {
        ...
        if (ConfiguracaoGlobal.isPROTECAO()) { //SE A PROTEÇÃO ESTIVER ATIVA
            ...
            if (pd.isAutorizado()) { //SE O USUARIO ESTIVER AUTORIZADO
                ...
                iniciarTelaPrincipal(Principal.principalScene(), ConfiguracaoGlobal.getTITULO_INICIAL());
    ...
    public static void iniciarTelaPrincipal(Scene scene, String titulo) { //INICIA TELA PRINCIPAL
        primaryStage.setTitle(titulo);
        primaryStage.getIcons().addAll(new Image(Principal.class.getResourceAsStream("/scp/imgs/"+ConfiguracaoGlobal.getICONE_IMG())));
    ...
    public static void iniciarTelaErro() { //INICIA TELA DE ERRO
        try {
            ...
            errorStage.getIcons().addAll(new Image(Principal.class.getResourceAsStream("/scp/imgs/"+ConfiguracaoGlobal.getICONE_IMG())));
    ...
    public static void novaTela(Scene scene, String titlePage, boolean resizable) {
        ...
        stage.getIcons().add(new Image(Principal.class.getResourceAsStream("/scp/imgs/"+ConfiguracaoGlobal.getICONE_IMG())));
